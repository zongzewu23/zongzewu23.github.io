  ...
  return (
    ...
    >
      <div className="flex flex-col space-y-5 items-center ">
        <div className="relative flex items-center justify-center  bg-[#55D6BE] h-24 w-24 rounded-full">
      ...
      <div className="mt-5 md:mt-12">
        <h1 className="text-center text-lg lg:text-xl text-primary text-[#200714]">
          Technologies I know:
        </h1>
        <div className="flex flex-wrap gap-2 mt-4 justify-center items-center text-lg">
          {skills?.map((skill, i) => (
            ...
            >
              ...
              <span className="text-md"  data-blobity>{skill.name}</span>
            </div>
          ))}
        </div>
      </div>
