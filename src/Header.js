...
function Header() {
    return (
        <header className="bg-gradient-to-r from-purple-500 to-indigo-300 text-white p-4 shadow-lg font-England">
            <div className="container mx-auto flex justify-between items-center">
                <h1 className="text-3xl  font-bold font-England tracking-tight">Zongze Wu</h1>
                <nav className="hidden md:flex space-x-8">
                    <a href="#home" className="text-lg font-England  hover:text-indigo-200 transition duration-200">Home</a>
